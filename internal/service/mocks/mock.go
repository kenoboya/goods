...
func (mr *MockProductsMockRecorder) GetProductsByID(ctx, productID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBasketsMockRecorder) AddProduct(ctx, customerID, productID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBasketsMockRecorder) DeleteProduct(ctx, customerID, productID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBasketsMockRecorder) UpdateProduct(ctx, customerID, productID, quantity interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOrdersMockRecorder) SaveOrder(ctx, order interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
